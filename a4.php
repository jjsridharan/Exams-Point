...
<gcse:search></gcse:search>
		...
		<div id="d4">
			<button id="b9">Brief History of PHP</button>
			<button id="b10">Learn PHP</button>
		</div>
		<div id="d5">
			<p style="font-size:30px">PHP development began in 1994 when Rasmus Lerdorf wrote several Common Gateway Interface (CGI) programs in C,[9][10][11] which he used to maintain his personal homepage. He extended them to work with web forms and to communicate with databases, and called this implementation "Personal Home Page/Forms Interpreter" or PHP/FI.</p>
		</div>
		<div id="d6">
