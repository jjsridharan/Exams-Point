...
<html lang="en">
	...
	<body background="back.jpg">
		...
		<div id="d2">
			...
			<a href=addq.php><button id="b6">Add Question
</button></a>
...
<gcse:search></gcse:search>
		...
		<div id="d7">
			<a href=easycss.php><button id="b11">Easy</button></a>
			<a href=medcss.php><button id="b12">Medium</button></a>
			<a href=hardcss.php><button id="b12">Hard</button></a>
		</div>
		</div>
	</body>
</html>