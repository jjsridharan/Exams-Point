...
<gcse:search></gcse:search>
		...
		<div id="d4">
			<button id="b9">Brief History of DBMS</button>
			<button id="b10">Learn DBMS</button>
		</div>
		<div id="d5">
			<p style="font-size:30px">A database management system (DBMS) is a computer software application that interacts with the user, other applications, and the database itself to capture and analyze data. A general-purpose DBMS is designed to allow the definition, creation, querying, update, and administration of databases. Well-known DBMSs include MySQL, PostgreSQL, Microsoft SQL Server, Oracle, Sybase, SAP HANA, and IBM DB2.</div>
		<div id="d6">
		...
		<div id="d7">
			<a href=easyhtml.php><button id="b11">Easy</button></a>
